...
from .utils import (AppCommandOrGroup, AppCommandsGroup, FieldData,
                    generate_warnings_field, get_embed_color, get_embed_footer,
                    get_send_callback)
...
async def _generate_subcommands_field(ctx: MyContext, cmd: AppCommandsGroup) -> FieldData | None:
