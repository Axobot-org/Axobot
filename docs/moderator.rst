...
* Smooth
    ...
    * time-out for 30min users sending 10 attachments in a short time
* Careful
    ...
    * time-out for 1h users sending 8 attachments in a short time
    * time-out for 30min users sending 20 mentions in a short time
    * time-out for 15min users sending 10 mentions in a short time
    * time-out for 10min users sending 6 attachments in a short time
* High
    ...
    * kick users sending 8 attachments in a short time
...
* Extreme
    ...
    * ban users sending 8 attachments in a short time for a week
